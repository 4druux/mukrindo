// src/components/admin/dashboard/CarProductsTable.jsx
"use client";
...
const CarProductsTable = () => {
  ...
  return (
    <div className="border border-gray-200 md:border-none md:rounded-2xl md:shadow-md px-3 bg-white pb-5 pt-5 sm:px-6 sm:pt-6">
          ...
          <div className="flex items-center gap-0.5 rounded-lg bg-gray-100 p-1 w-full sm:w-auto">
            {TAB_CONFIG.map((tab) => (
              <button
                ...
                className={`px-3 py-1.5 font-semibold w-full rounded-md text-[10px] md:text-xs cursor-pointer transition-colors duration-150 ${
